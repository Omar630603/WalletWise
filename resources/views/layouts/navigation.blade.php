    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between  h-16 px-4">
            <div class="hidden sm:flex shrink-0 items-center">
                <span
                    class="text-xl font-bold text-primaryDark dark:text-primaryLight">{{ config('app.name', 'WalletWise') }}</span>
            </div>
                    ...
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="flex gap-2 justify-center items-center">
                                <span
                                    class="w-9 h-9 flex justify-center items-center rounded-full bg-primaryDark dark:bg-primaryLight text-primaryLight dark:text-primaryDark">{{ Auth::user()->getUserNameLettersAttribute() }}
                                </span>
                            </div>
                            <div class="ms-1">
